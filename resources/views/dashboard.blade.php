<x-app-layout>
    <div class="mx-auto max-w-7xl">
        ...
        <div id="PageSkeleton" class="animate-pulse space-y-6">
            ...
            <div class="mb-6">
                <div class="h-8 bg-gray-200 rounded dark:bg-gray-700 w-64 mb-2"></div>
            ...
            <div class="bg-white dark:bg-[#171717] border border-gray-200 dark:border-gray-800 rounded-lg p-4">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    @endif
                    <div class="h-10 bg-gray-200 rounded dark:bg-gray-700 w-full self-end"></div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 gap-4 mb-6 sm:grid-cols-2 lg:grid-cols-4 sm:gap-6">
                ...
                <div class="bg-white dark:bg-[#171717] border border-gray-200 dark:border-gray-800 rounded-lg p-6">
                    ...
                    <div class="mt-4 h-4 bg-gray-200 rounded dark:bg-gray-700 w-40"></div>
                </div>
                @endfor
            </div>
            ...
            <div class="bg-white dark:bg-[#171717] border border-gray-200 dark:border-gray-800 rounded-lg p-6">
                <div class="h-6 bg-gray-200 rounded dark:bg-gray-700 w-48 mb-6"></div>
                <x-table-skeleton :rows="5" :columns="3" :headers="true" :colSizes="['w-1/2', 'w-1/4', 'w-1/4']" />
            </div>
        </div>
        ...
        <div id="RealPageContent" class="hidden opacity-0 transition-opacity duration-500">
            ...
            <div class="mb-6 bg-white dark:bg-[#171717] border border-gray-200 dark:border-gray-800 rounded-lg p-4">
                <form method="GET" action="{{ route('dashboard') }}" class="space-y-4" id="dashboardFilterForm">
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                        <div class="w-full">
                    ...
                    <span id="filterLoadingIndicator" class="hidden items-center gap-2 mt-2">
                        ...
                        <span class="text-xs text-gray-500">Updating dashboard data...</span>
                    </span>
                </form>
            </div>
    ...
    <script>
        ...
        // FIXED: Do not disable inputs, otherwise values won't be sent!
        function handleFilterChange() {
            ...
            // Just apply a visual disable (transparency) to prevent interaction
            // but DO NOT set .disabled = true on inputs
                    ...
                    options: {
                        ...
                        plugins: {
                            ...
                            tooltip: {
                                ...
                                usePointStyle: true,
                                callbacks: {
                                    label: (context) => `Daily Sales: ₱${context.parsed.y.toLocaleString('en-US', { minimumFractionDigits: 2 })}`
                                }
                            }
                        },
                        scales: {
            ...
            if (topProductsCtx) {
                ...
                topProductsChart = new Chart(topProductsCtx, {
                    ...
                    options: {
                        ...
                        scales: isMobile ? {
                            x: { ...responsiveScales.y, ticks: { ...responsiveScales.y.ticks, callback: (value) => '₱' + value.toLocaleString('en-US', { maximumFractionDigits: 0 }) } },
                            y: responsiveScales.x
                        } : {
                            y: { ...responsiveScales.y, ticks: { ...responsiveScales.y.ticks, callback: (value) => '₱' + value.toLocaleString('en-US', { maximumFractionDigits: 0 }) } },
                            x: responsiveScales.x
                        }
                    }
                });
                    ...
                    options: {
                        ...
                        plugins: {
                            legend: {
                                ...
                                labels: { padding: isMobile ? 8 : 15, usePointStyle: true, pointStyle: 'circle', font: { size: isMobile ? 10 : 11 }, color: colors.text }
                            }
                        }
                    }
                });
