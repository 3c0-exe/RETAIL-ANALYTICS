<x-app-layout>
    <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-white dark:bg-[#171717] border border-gray-200 dark:border-gray-800 rounded-lg p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-2">₱0.00</p>
                    </div>
                ...
                <div class="mt-4 flex items-center text-sm">
                    <span class="text-green-600 dark:text-green-400 font-medium">Coming in Phase 5</span>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-[#171717] border border-gray-200 dark:border-gray-800 rounded-lg p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-2">0</p>
                    </div>
        ...
        <!-- Role Info -->
        <div class="mt-6 bg-primary-50 dark:bg-primary-900/10 border border-primary-200 dark:border-primary-800 rounded-lg p-6">
            <div class="flex items-start gap-3">
                ...
                <div>
                    <h3 class="text-sm font-semibold text-primary-900 dark:text-primary-100">Your Role: {{ ucfirst(str_replace('_', ' ', auth()->user()->role)) }}</h3>
