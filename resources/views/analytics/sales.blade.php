<x-app-layout>
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div id="PageSkeleton" class="animate-pulse space-y-6">
            ...
            <div class="grid grid-cols-1 gap-4 mb-6 sm:grid-cols-2 md:grid-cols-3 sm:gap-6">
                <div class="h-32 bg-white dark:bg-[#171717] rounded-lg border border-gray-200 dark:border-gray-800"></div>
                <div class="h-32 bg-white dark:bg-[#171717] rounded-lg border border-gray-200 dark:border-gray-800"></div>
                <div class="h-32 bg-white dark:bg-[#171717] rounded-lg border border-gray-200 dark:border-gray-800"></div>
            </div>
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="text-sm font-medium text-gray-500 dark:text-gray-400">Sales Analytics</span>
                            </div>
                        </li>
                    </ol>
                </nav>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            setTimeout(() => {
                ...
                if(realContent) {
                    ...
                    if (typeof initializeSalesCharts === 'function') initializeSalesCharts();
        ...
        window.handleExport = (form) => {
            // Close dropdown if using Alpine (optional)
            // this.open = false;
