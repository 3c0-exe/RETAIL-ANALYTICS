<x-app-layout>
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-[#171717] border border-gray-200 dark:border-gray-800 rounded-lg p-4 mb-6">
                <div class="space-y-3">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                        <div class="h-10 bg-gray-200 rounded dark:bg-gray-700"></div> <div class="h-10 bg-gray-200 rounded dark:bg-gray-700"></div> <div class="flex gap-2 sm:col-span-2 lg:col-span-1">
                            <div class="h-10 bg-gray-200 rounded dark:bg-gray-700 flex-1"></div> <div class="h-10 bg-gray-200 rounded dark:bg-gray-700 flex-1"></div> </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-[#171717] border border-gray-200 dark:border-gray-800 rounded-lg overflow-hidden">
                ...
                <div class="hidden md:block">
                    <x-table-skeleton
                        rows="5"
                        :headers="true"
                        :colSizes="['w-16', 'w-1/4', 'w-1/6', 'w-1/6', 'w-1/12', 'w-1/12', 'w-1/12', 'w-1/6']"
                    />
                </div>
            </div>
        </div>
        ...
        <div id="RealPageContent" class="hidden opacity-0 transition-opacity duration-500">
            ...
            <div class="bg-white dark:bg-[#171717] border border-gray-200 dark:border-gray-800 rounded-lg p-4 mb-6">
                <form method="GET" action="{{ route('admin.products.index') }}" onsubmit="handleFilter(this)" class="space-y-3">
                    <div class="w-full">
                        <input type="text"
                               name="search"
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-800">
                            @forelse($products as $product)
                                <tr class="hover:bg-gray-50 dark:hover:bg-[#0a0a0a] transition">
                                    <td class="px-4 py-3">
                                        @if($product->image)
                                            <img src="{{ Storage::url($product->image) }}" alt="{{ $product->name }}" class="object-cover w-12 h-12 rounded">
                                        @else
