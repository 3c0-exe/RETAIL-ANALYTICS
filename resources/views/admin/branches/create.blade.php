<x-app-layout>
    <div class="max-w-3xl mx-auto">
        ...
        {{-- ============================================================== --}}
        <div id="FormSkeleton" class="animate-pulse space-y-8">

            <div class="space-y-4">
                <div class="h-4 bg-gray-200 rounded dark:bg-gray-700 w-32"></div> <div class="h-8 bg-gray-200 rounded dark:bg-gray-700 w-64"></div> </div>

            <div class="bg-white dark:bg-[#171717] border border-gray-200 dark:border-gray-800 rounded-lg p-6 space-y-6">

                <div class="space-y-2">
                    <div class="h-4 bg-gray-200 rounded dark:bg-gray-700 w-32"></div> <div class="h-10 bg-gray-200 rounded dark:bg-gray-700 w-full"></div> </div>
        ...
        <div id="RealFormContent" class="hidden opacity-0 transition-opacity duration-500">
            <div class="mb-8">
                ...
                <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Create New Branch</h1>
            </div>

            <div class="bg-white dark:bg-[#171717] border border-gray-200 dark:border-gray-800 rounded-lg p-6">
                <form action="{{ route('admin.branches.store') }}" method="POST" onsubmit="showFormLoading(this)">
                    @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <input
                            ...
                            maxlength="10"
                            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                            placeholder="e.g., MNL, CEB"
                            required
                        >
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Unique 3-10 character code</p>
                        @error('code')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <select
                                ...
                                required
                            >
                                <option value="Asia/Manila" {{ old('timezone') === 'Asia/Manila' ? 'selected' : '' }}>Asia/Manila</option>
                    ...
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Only unassigned managers shown</p>
                        @error('manager_id')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
